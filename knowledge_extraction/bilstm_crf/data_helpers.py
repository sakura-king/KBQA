...
#     nd = NerDataProcessor(max_len=80, vocab_size=2410)
#     path = 'D:/code/KBQA-for-Diagnosis-main/knowledge_extraction/ChineseBLUE/cMedQANER/dev.txt'
#     d, y = nd.read_data(path)
#     print(d[:3])